                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="custom-tab">
                                    ...
                                    ?>
                                                <label for="<?php echo($items[0]); ?>" class="form-check-label ">
                                                            <input type="checkbox" id="<?php echo($items[0]); ?>" name="<?php echo($items[0]); ?>" value="<?php echo($items[0]); ?>" class="form-check-input"> <?php echo($items[0]); ?>
                                                </label>
                                    <?php
                                            }
                                            fclose($file);
