                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="progress mb-2">
                                        <div class="progress-bar bg-success" role="progressbar" style="width: 96%" aria-valuenow="96" aria-valuemin="0" aria-valuemax="100" onclick="location.href='#custom-nav-6'">96%</div>
                                    </div>
                                    <div class="progress mb-2">
