                                    ...
                                    <div class="col col-md-12">
                                        <div>
                                            <>
                                                ...
                                                <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="高血脂" class="form-check-input">高血脂</label><br>
                                                ...
                                                <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="子宮內膜異位症" class="form-check-input">子宮內膜異位症</label>                                                <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="" class="form-check-input"></label>
                                                ...
                                                <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="白內障" class="form-check-input">白內障</label>                                                <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="" class="form-check-input"></label>
                                                ...
                                                <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="攝護腺肥大" class="form-check-input">攝護腺肥大</label><br>
                                                ...
                                                <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="氣喘" class="form-check-input">氣喘</label>
                                                <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="過敏性鼻炎" class="form-check-input">過敏性鼻炎</label><br>
                                                ...
                                                <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="乾癬" class="form-check-input">乾癬</label>                                                <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="" class="form-check-input"></label>
                                                <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="牙周病" class="form-check-input">牙周病</label>
                                                <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="口腔癌" class="form-check-input">口腔癌</label><br>
                                                ...
                                                <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="胃癌" class="form-check-input">胃癌</label><br>
                                                ...
                                                <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="乳癌" class="form-check-input">乳癌</label><br>
                                                ...
                                                <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="膀胱癌" class="form-check-input">膀胱癌</label><br>
