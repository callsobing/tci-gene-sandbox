                        ...
                        <div class="card-body card-block">
                            <form id="pond_form" name="pond_form" action="g2_management.php" method="post" enctype="multipart/form-data" class="form-horizontal" onSubmit="return check_filed(this)">
                                <div class="col-md-3">
                                    ...
                                    <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="晚發型阿茲海默症" class="form-check-input">晚發型阿茲海默症</label></p><p>
                                    ...
                                    <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="子宮內膜異位症" class="form-check-input">子宮內膜異位症</label></p><p>
                                    ...
                                    <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="紅斑性狼瘡" class="form-check-input">紅斑性狼瘡</label></p><p>
                                    ...
                                    <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="膽石症" class="form-check-input">膽石症</label></p><p>
                                    ...
                                    <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="青光眼" class="form-check-input">青光眼</label></p><p>
                                    ...
                                    <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="思覺失調症" class="form-check-input">思覺失調症</label></p><p>
                                    ...
                                    <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="氣喘" class="form-check-input">氣喘</label></p><p>
                                    ...
                                    <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="口腔癌" class="form-check-input">口腔癌</label></p><p>
                                    ...
                                    <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="肝癌" class="form-check-input">肝癌</label></p><p>
                                    ...
                                    <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="子宮頸癌" class="form-check-input">子宮頸癌</label></p><p>
