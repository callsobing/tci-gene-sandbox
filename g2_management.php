                        ...
                        <div class="card-body card-block">
                            <form id="pond_form" name="pond_form" action="g2_management.php" method="post" enctype="multipart/form-data" class="form-horizontal" onSubmit="return check_filed(this)">
                                <div>
                                    ...
                                    <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="高血脂" class="form-check-input">高血脂</label></div><div class="col col-md-3">
                                    ...
                                    <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="腦中風" class="form-check-input">腦中風</label></div><div class="col col-md-3">
                                    ...
                                    <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="退化性關節炎" class="form-check-input">退化性關節炎</label></div><div class="col col-md-3">
                                    ...
                                    <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="子宮肌瘤" class="form-check-input">子宮肌瘤</label></div><div class="col col-md-3">
                                    ...
                                    <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="紅斑性狼瘡" class="form-check-input">紅斑性狼瘡</label></div><div class="col col-md-3">
                                    ...
                                    <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="脂肪肝" class="form-check-input">脂肪肝</label></div><div class="col col-md-3">
                                    ...
                                    <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="胰臟炎" class="form-check-input">胰臟炎</label></div><div class="col col-md-3">
                                    ...
                                    <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="高度近視" class="form-check-input">高度近視</label></div><div class="col col-md-3">
                                    ...
                                    <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="慢性阻塞性肺病" class="form-check-input">慢性阻塞性肺病</label></div><div class="col col-md-3">
                                    ...
                                    <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="氣喘" class="form-check-input">氣喘</label></div><div class="col col-md-3">
                                    ...
                                    <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="牙周病" class="form-check-input">牙周病</label></div><div class="col col-md-3">
                                    ...
                                    <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="肺癌" class="form-check-input">肺癌</label></div><div class="col col-md-3">
                                    ...
                                    <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="胰臟癌" class="form-check-input">胰臟癌</label></div><div class="col col-md-3">
                                    ...
                                    <label for="checkbox" class="form-check-label "><input type="checkbox" name="disease[]" value="攝護腺癌" class="form-check-input">攝護腺癌</label></div><div class="col col-md-3">
