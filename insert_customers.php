...
while (!feof($file)) {
    ...
    $sql = "INSERT INTO customer_g2 " .
        ...
        '$items[60]', '$items[61]', '$items[62]', '$items[63]', '$items[64]', '$items[65]', '$items[66]'
        )";
