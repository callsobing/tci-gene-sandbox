...
<head>
    ...
    <!-- Title Page-->
    <title>TCI Gene dashboard</title>
            ...
            <div class="header-mobile__bar">
                <div class="container-fluid">
                    <div class="header-mobile-inner">
                        <img src="images/tci-gene.png" alt="Tci-Gene" width="60%"/>
                        ...
                        <div class="row">
                                        ...
                                        <div class="chart-info">
                                            ...
                                            <div class="chart-info__right">
                                                <div class="chart-statis">
                                                    ...
                                                    <span class="label">細胞實驗</span>
                                                </div>
                                                <div class="chart-statis mr-0">
                                                    <span class="index decre">
                                                        <i class="zmdi zmdi-long-arrow-up"></i>10%</span>
                                                    <span class="label">基因檢測</span>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="col-lg-6">
                                <div class="au-card chart-percent-card">
                                    <div class="au-card-inner">
                                        <h3 class="title-2 tm-b-5">實驗分類百分比</h3>
                            ...
                            <div class="col-lg-6">
                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    <div class="au-card-title" style="background-image:url('images/bg-title-01.jpg');">
                                        ...
                                        <h3>
                                            <i class="zmdi zmdi-account-calendar"></i>30 Nov, 2018</h3>
                                    ...
                                    <div class="au-task js-list-load">
                                        <div class="au-task__title">
                                            <p>Tasks for Yian.Tung</p>
                                        </div>
                                        <div class="au-task-list js-scrollbar3">
                                            <div class="au-task__item au-task__item--danger">
                                                <div class="au-task__item-inner">
                                                    <h5 class="task">
                                                        <a href="#">2019 年度計畫討論</a>
                                                    </h5>
                                        ...
                                        <div class="au-task__footer">
                                            <button class="au-btn au-btn-load js-load-btn">載入更多..</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="au-card au-card--no-shadow au-card--no-pad m-b-40">
                                    <div class="au-card-title" style="background-image:url('images/bg-title-02.jpg');">
                                        <div class="bg-overlay bg-overlay--blue"></div>
                                        <h3>
                                            <i class="zmdi zmdi-comment-text"></i>您的留言</h3>
                                        <button class="au-btn-plus">
                                            <i class="zmdi zmdi-plus"></i>
                                        </button>
                                    </div>
